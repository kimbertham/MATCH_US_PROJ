"""
Django settings for MATCHUS project.
...
SECRET_KEY = 'yuf0^urrkj9j1)7obvdl_+_ao8kl%x==_+uyh&ko4@pw!h_40d'
...
WSGI_APPLICATION = 'MATCHUS.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'match_us', "build", "static")
