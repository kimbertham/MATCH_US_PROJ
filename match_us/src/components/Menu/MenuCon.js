  ...
  render(){
    ...
    return (
      <>
        ...
        <Link to={`/connection/${id}/events`}><h1>Locations</h1></Link>
        <Link to={`/connection/${id}/events`}><h1>Randomiser</h1></Link>
        <Link to={`/connection/${id}/events`}><h1>Activities</h1></Link>
        <Link to={`/connection/${id}/events`}><h1>Notes</h1></Link>
        <Link to={`/connection/${id}/events`}><h1>Wishlist</h1></Link>
